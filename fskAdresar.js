...
function lista(){
var studenti = getStudentsFromStorage();
var listaStudenata = "";
for (let i = 0; i < studenti.length; i++) {
    listaStudenata += `<br><br>${studenti[i].index}
    ${studenti[i].ime} ${studenti[i].prezime}<br>`
 }
document.getElementById("ispis").innerHTML = "Lista studenata je " + listaStudenata;
}